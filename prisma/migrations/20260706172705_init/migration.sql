...
-- CreateEnum
CREATE TYPE "TaskType" AS ENUM ('CALL', 'WHATSAPP', 'EMAIL', 'MEETING', 'VISIT', 'PROPOSAL', 'NOTE', 'OTHER');
...
-- CreateIndex
CREATE INDEX "Task_organizationId_ownerId_dueAt_idx" ON "Task"("organizationId", "ownerId", "dueAt");
