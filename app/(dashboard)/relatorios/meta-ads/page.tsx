      ...
      <div className="max-w-7xl space-y-6">
        <div>
          ...
          <p className="mt-1 text-sm text-neutral-500 dark:text-neutral-400">
            Leads recebidos via formulário nativo do Facebook/Instagram, agrupados por campanha.
            Acompanhe a jornada completa: formulário → WhatsApp → resposta → qualificação → venda.
          </p>
        </div>
