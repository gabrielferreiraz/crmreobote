...
// NewTaskDialog foi extraído pra components/new-task-dialog.tsx (mesmo
// componente, reaproveitado agora também pelo painel de Informações do
// WhatsApp) — importado no topo deste arquivo.
