 ...
 *
 * Identidade visual própria da Reobote (não cópia do Taggo usado como
 * referência) — base escura sofisticada (mercado financeiro/comercial),
 * acento na cor de marca real da Reobote (#00aeee, mesma do logo — ver
 * components/reobote-logo.tsx), foto circular, hierarquia clara,
 * sem excesso de animação/poluição.
 */
export function DigitalCardView({
  ...
  return (
    <div className="mx-auto w-full max-w-sm">
      <div className="overflow-hidden rounded-3xl bg-gradient-to-b from-[#12141c] to-[#0a0b10] px-6 pb-7 pt-9 text-center shadow-2xl ring-1 ring-white/10">
        {/* Foto */}
        <div className="mx-auto mb-4 h-24 w-24 overflow-hidden rounded-full ring-2 ring-[#00aeee]/40 ring-offset-4 ring-offset-[#12141c]">
          {data.photoUrl ? (
